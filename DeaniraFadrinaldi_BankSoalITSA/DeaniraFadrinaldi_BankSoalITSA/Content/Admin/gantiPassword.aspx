<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="gantiPassword.aspx.vb" Inherits="DeaniraFadrinaldi_BankSoalITSA.gantiPassword1" %>
            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="gantiPassword.aspx">
                                ...
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-4 text-right">
                                            <asp:Button runat="server" ID="btnSimpan" OnClick="btnSimpan_Click" CssClass="btn btn-sm btn-primary" Text="Simpan"></asp:Button>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="currentPassword" CssClass="form-control" type="password" placeholder="Current Password" runat="server" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="newPassword" CssClass="form-control" type="password" placeholder="New Password" runat="server" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="input-first-name">Confirm New Password</label>
                                                    <asp:TextBox ID="newPassword2" CssClass="form-control" type="password" placeholder="Confirm New Password" runat="server" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
