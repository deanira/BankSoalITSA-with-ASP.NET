<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pilihSoal.aspx.vb" Inherits="DeaniraFadrinaldi_BankSoalITSA.pilihSoal" %>
                            ...
                            <ItemTemplate>
                                <div class="col-lg-3 col-md-6">
                                    <div class="member" data-aos="zoom-in" data-aos-delay="100">
                                        <div class="pic">
                                            <img src="file.png" class="img-fluid" alt="">
                                        </div>
                                        <div class="member-info">
                                            <h4><%# Eval("deskripsi")%> </h4>
                                            <span><%# Eval("tahun_ajaran") %></span>
                                            <div class="social">
                                                <asp:LinkButton runat="server" OnClick="view" CommandArgument='<%# Eval("id") %>'><i class="icofont-ui-search"></i></asp:LinkButton>
                                                <asp:LinkButton runat="server" OnClick="DownloadFile" CommandArgument='<%# Eval("id") %>'><i class="icofont-download"></i></asp:LinkButton>
                                            </div>
                                        </div>
                                    </div>
                                </div>
