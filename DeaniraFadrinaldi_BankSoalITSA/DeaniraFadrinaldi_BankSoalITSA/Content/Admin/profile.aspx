<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="profile.aspx.vb" Inherits="DeaniraFadrinaldi_BankSoalITSA.profile" %>
            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="profile.aspx">
            ...
            <div class="container-fluid d-flex align-items-center">
                <div class="row">
                    <div class="col-md-auto">
                        <h1 class="display-2 text-white">Hello <%= Session("nama_user").ToString %></h1>
                        <p class="text-white mt-0 mb-5">Anda adalah <%= Session("role").ToString %></p>
                        <a href="../index.aspx" class="btn btn-neutral">Logout</a>
                    </div>
                </div>
            </div>
        </div>
