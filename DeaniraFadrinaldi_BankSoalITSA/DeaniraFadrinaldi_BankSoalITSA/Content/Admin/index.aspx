<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="index.aspx.vb" Inherits="DeaniraFadrinaldi_BankSoalITSA.index1" %>
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <h5 class="card-title text-uppercase text-muted mb-0">Jumlah Soal</h5>
                                            <span class="h2 font-weight-bold mb-0"><%= jmlSoal.ToString %></span>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <span class="h2 font-weight-bold mb-0"><%= jmlPengguna.ToString() %></span>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <span class="h2 font-weight-bold mb-0"><%= jmlAdmin.ToString() %></span>
                                        </div>
                                        <div class="col-auto">
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6">
                        <div class="copyright text-center  text-lg-left  text-muted">
                            &copy; 2020 <a href="#" class="font-weight-bold ml-1" target="_blank">Bank Soal ITSA</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
